/*
  Made by Ashwin Gurbuxani, based on Gabriel Nunes' code.
*/


// I want to pull quotes from this txt file https://github.com/caelancollins/Hedberg-bot/blob/master/mitch.txt
...
function getQuote() {
  $.ajax({
    ...
    url: 'https://raw.githubusercontent.com/caelancollins/Hedberg-bot/master/mitch.txt',
    success: function(r) {
      if (typeof r === 'string') {
       r = JSON.parse(r); 
      }
